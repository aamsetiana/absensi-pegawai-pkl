                                ...
                                <?php $no = 1 + ($pager->getCurrentPage() - 1) * $pager->getPerPage(); ?>
                                    <?php foreach ($listPegawai as $p) : ?>
                                        <tr>
                                            ...
                                            <td><img src="<?= base_url('assets/img/') . $p['gambar']; ?>" alt="" width="110" height="100" class="img-responsive"></td>
                                            <td>
                                                <button type="button" class="btn btn-success view-user" data-toggle="modal" data-target="#detailPegawai" data-nip="<?= $p['nip']; ?>">
                                                    <i class="fas fa-info-circle"></i>
                                                </button>
                                                <a href="" class="btn btn-primary btn-md"><i class="fas fa-user-plus"></i></a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    var pegawaiDetailHtml = '<div class="row">' +
                        '<div class="col-5">' +
                        '<img src=" <?= base_url('assets/img/') ?>' + response.gambar + '" alt="" width="150px" height="150px">' +
                        '</div>' +
                        '<div class="col-7">' +
